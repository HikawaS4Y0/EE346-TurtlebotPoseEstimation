...
class RobotRun:
    def __init__(self):
        ...
        self.locations={1:((4.02028627077,4.18346248303,0.0),(0.0,0.0,0.998375561307,0.0569757719158)),
                        2:((-0.0817270829501-0.1,3.92411381007-0.0,0),(0,0,-0.7,0.71)),
                        4:((4.18356752335-0.1,0.100314113691+0.03,0.0),(0,0,0.9998,0.02)),
        ...
        self.ckpt={1:((3.23534612934-0.2,3.32886478703-0.3,0.0),(0.0,0.0,-0.986964821947,0.160936137147)),
                   2:((2.06065698749+0.05,3.35087398272,0.0),(0.0,0.0,0.0301346368705,0.999545848704)),
                   3:((0.084077691137,0.00733391767957-0.05,0.0),(0,0,0.15,0.99)),
                   4:((3.23534612934-0.2,3.32886478703-0.3,0.0),(0.0,0.0,-0.986964821947,0.160936137147))
        }
        # pre set 
    ...
    def aruco_detect(self,msg):
        ...
        if len(corners) > 0 and not find:
	        for marker_id in ids:
                    ...
                    # self.soundhandle.say('beep', 'voice_kal_diphone', 1) 
